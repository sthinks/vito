...
import VedatBey from "../.././assets/institutional/vedattbey.jpg";
import Fuat from "../.././assets/institutional/Fuat Şengül.png";
import Burhan from "../.././assets/institutional/gm.png";
...
import Tahir from "../.././assets/institutional/tahirpolat.png";
...
function Institutional() {
    ...
    return (
        <>
            <Header />
            <div className="relative w-full flex justify-center items-center h-[600px] max-md:lg-[400px]">
                <img src={InstBanner} alt="instbanner" />
                <div className="absolute bg-blue-800 opacity-25 w-full h-full left-0 top-0" />
                <h2 className="overlay-text mt-10 absolute text-center text-6xl text-white bg-opacity-70 px-2 py-1 rounded font-bold">
                    CORPORATE
                </h2>
            </div>
                    ...
                    <div className="flex flex-1 flex-col  ">
                        ...
                        <div className="sol-alt w-full h-full">
                            <img
                                src={VedatBey}
                                alt="deneme"
                                className="w-full object-cover object-right h-full"
                            />
                        </div>
                    </div>
            ...
            <div className="flex flex-row justify-between w-full h-full max-lg:flex-col-reverse">
                <div className="bg-[#093977]  text-white w-[65%] p-4 text-left h-[450px] max-lg:w-full max-lg:h-auto">
                    <h2 className="text-3xl font-semibold">Fuat Şengül</h2>
                    <p className="text-xl mt-5">
                        Vito Engineering Construction and Contracting Inc. Vice
                        Chairman of the Board of Directors Born in 1964 in
                        Istanbul, Fuat Şengül graduated from Istanbul Technical
                        University, Department of Civil Engineering (1985) and
                        received his master's degree from Istanbul Technical
                        University, Faculty of Engineering (1987). He received
                        his specialization certificate from Marmara University
                        Finance and Accounting Department (1988). Mr. Şengül
                        worked as an investment appraiser in private banks and
                        served as General Manager and Board Member at Istanbul
                        Gaz Dağıtım A.Ş. (İGDAŞ) (1994-2000). In 2001, Mr.
                        Şengül joined the Vito Group and currently serves as
                        Vice Chairman of the Board of Directors at Vito
                        Engineering Construction and Contracting Inc. He is
            ...
            <div className="flex flex-row justify-between w-full h-full max-lg:flex-col-reverse">
                <div className="w-1/2 max-lg:w-full  ">
                    <h2 className="text-3xl font-semibold p-5 mb-1">
                        Zeki Günay
                    </h2>
            ...
            <div className="flex flex-row justify-between  bg-[#00a1e0] w-full max-lg:flex-col">
                ...
                <div className="bg-[#093977]  text-white w-[65%] p-4 text-left h-auto max-lg:w-full">
                    <h2 className="text-3xl font-semibold px-5 py-2">
                        Dinç Şenlier
                    </h2>
                    <br />
            ...
            <div className="flex flex-row justify-between w-full h-full max-lg:flex-col-reverse">
                <div className="bg-[#5caab3]  text-white w-[65%] p-4 text-left h-[450px] max-lg:w-full max-lg:h-auto">
                    <h2 className="text-3xl font-semibold">
                        Reha Akın / Construction Engineer
                    </h2>
                    <p className="text-xl mt-5">
            ...
            <div className="flex flex-row justify-between w-full h-full max-lg:flex-col">
                <div className="w-[8%] flex-col text-center ">
                    <div className=" bg-[#313e72] h-4/5  flex justify-center items-center max-lg:hidden">
                        <p
                            className="text-white text-3xl"
                            style={{
                                transform: "rotate(-180deg)",
                ...
                <div className="hidden max-lg:flex bg-[#3d5869f0] w-full h-auto justify-center items-center ">
                    <p className="text-white text-2xl p-1 max-lg:text-xl">
                        Financial And Administrative Director
                    </p>
                </div>
                ...
                <div className="bg-[#6786bc]  text-white w-[65%] p-4 text-left h-[450px] max-lg:w-full h-auto">
