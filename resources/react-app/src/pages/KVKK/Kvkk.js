    ...
    return (
        <div className="w-full">
            ...
            <div className="container mx-auto px-24 max-lg:px-16 max-md:px-5 my-14">
                <p className="w-full justify-start items-start text-3xl font-bold max-md:text-lg my-10">
                    {data?.title}
                </p>
                <div className="py-2">
                    <p className="text-lg  py-2">
                        ...
                        until measures are taken; We believe that all accidents
                        are preventable and we continue to pursue the goal of
                        "Zero Accidents" in all our activities. We communicate
                        our principles and commitments regarding
                        <a
